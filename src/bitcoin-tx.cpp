...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("hda-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hda-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hda transaction") + "\n" +
              "  hda-tx [options] -create [commands]   " + _("Create hex-encoded hda transaction") + "\n" +
              "\n";
