...
test_rpath_runpath "${REPOROOT}/src/hdad"
test_rpath_runpath "${REPOROOT}/src/hda-cli"
test_rpath_runpath "${REPOROOT}/src/hda-gtest"
test_rpath_runpath "${REPOROOT}/src/hda-tx"
...
test_fortify_source "${REPOROOT}/src/hdad"
test_fortify_source "${REPOROOT}/src/hda-cli"
test_fortify_source "${REPOROOT}/src/hda-gtest"
test_fortify_source "${REPOROOT}/src/hda-tx"
